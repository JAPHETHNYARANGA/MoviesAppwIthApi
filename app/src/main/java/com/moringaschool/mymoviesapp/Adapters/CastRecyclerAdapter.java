package com.moringaschool.mymoviesapp.Adapters;
...
import com.moringaschool.mymoviesapp.Models.Cast;
...
public class CastRecyclerAdapter extends RecyclerView.Adapter<CastViewHolder> {
    ...
    public void onBindViewHolder(@NonNull  CastViewHolder holder, int position) {
        holder.textView_actor.setText(list.get(position).getActor_id());
